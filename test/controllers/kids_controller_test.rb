...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { name: @kid.name, nick: @kid.nick, person_id: @kid.person_id, year: @kid.year } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { name: @kid.name, nick: @kid.nick, person_id: @kid.person_id, year: @kid.year } }
