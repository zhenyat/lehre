...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { de: @sample.de, en: @sample.en, entry_id: @sample.entry_id, ru: @sample.ru } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { de: @sample.de, en: @sample.en, entry_id: @sample.entry_id, ru: @sample.ru } }
