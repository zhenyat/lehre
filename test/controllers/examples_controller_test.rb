...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { de: @example.de, en: @example.en, ru: @example.ru, verb_id: @example.verb_id } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { de: @example.de, en: @example.en, ru: @example.ru, verb_id: @example.verb_id } }
